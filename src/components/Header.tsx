  ...
  useEffect(() => {
    ...
    return (
        <header className="md:flex">
            <div 
                ref={mainRef}
                className={`main-nav lower-glassmorpihsm bg-bglight dark:bg-bgdark z-30 top-0 shadow-sm fixed duration-500 px-4 h-16 w-full ${navClassList.join(
                 " "
                )}`}
                >
                    ...
                    <nav className="flex items-center">
                        ...
                        >
                            ...
                            <svg
                                ...
                                width="24"
                                height="24"
                                className="dark:hidden inline-block transform scale-110 md:hover:fill-carrigreen "
                            >
